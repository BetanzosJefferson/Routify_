...
import CompanyPartnershipModal from "./company-partnership-modal";
...
function ReservationSelectionModal({ isOpen, onClose }: ReservationSelectionModalProps) {
  ...
  // Estado para controlar el modal de empresas vinculadas
  const [isCompanyModalOpen, setIsCompanyModalOpen] = useState(false);
  // Estado para almacenar IDs de reservaciones seleccionadas para transferir
  ...
  return (
    <>
          ...
          <div className="mt-6 flex justify-end space-x-2 pt-4 border-t">
            ...
            <Button 
              ...
              onClick={() => {
                ...
                // Guardar IDs seleccionados y mostrar modal de empresas vinculadas
      ...
      {/* Modal de empresas vinculadas */}
      <CompanyPartnershipModal
