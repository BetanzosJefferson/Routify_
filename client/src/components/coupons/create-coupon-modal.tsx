...
export function CreateCouponModal({ open, onClose }: CreateCouponModalProps) {
  ...
  const form = useForm<CouponFormValues>({
    ...
    defaultValues: {
      ...
      minPurchaseAmount: 0,
      active: true,
      expiryDate: new Date(new Date().setMonth(new Date().getMonth() + 1)), // Por defecto, expira en 1 mes
    },
  });
  
  // Mutación para crear un nuevo cupón
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Crear Nuevo Cupón Promocional</DialogTitle>
          <DialogDescription>
            Crea un cupón de descuento para tus clientes. Los cupones pueden ser por porcentaje o monto fijo.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Cuántas veces se puede usar este cupón en total.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
