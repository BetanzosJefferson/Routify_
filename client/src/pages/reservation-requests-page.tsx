                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <span className="text-muted-foreground">
                          {selectedRequest.trip?.isSubTrip ?
                            // If it's a sub-trip, use segmentOrigin and segmentDestination (full string)
                            `${selectedRequest.trip.segmentOrigin || "Origen no especificado"} - ${selectedRequest.trip.segmentDestination || "Destino no especificado"}`
                            :
                            // Otherwise, use route origin and destination (assuming extractCityName is still desired here for general routes)
                            `${extractCityName(selectedRequest.route?.origin) || "Origen no especificado"} - ${extractCityName(selectedRequest.route?.destination) || "Destino no especificado"}`
                          }
                        </span>
                      </div>
                    </div>
